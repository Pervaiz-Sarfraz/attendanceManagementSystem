...
from attendance.views import AdminLoginView,TeacherView,ClassViewSet,AssignmentView,TeacherLoginView,StudentViewSet,AttendanceViewSet,TeacherSetPasswordView
